...
def search_and_download_manga_poster(manga_name):
    ...
    # Create directory for saved posters if it doesn't exist
    directory = Path("Manga Poster")
    ...
    poster_path = directory / f"{formatted_manga_name}_poster.jpg"  # Save the poster inside the created directory
...
def main():
    manga_name = input("Please enter the name of the manga poster you want to download: ")
    search_and_download_manga_poster(manga_name)
